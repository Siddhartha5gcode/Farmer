...
function initTicker() {
  ...
  let tickerHTML = "";
  const allRates = [...MANDI_RATES, ...MANDI_RATES]; // Duplicate for smooth infinite scrolling loop
...
// --- AI Quality Calculator Score Logic ---
function calculateQualityScore() {
  ...
  // Benchmark estimated price per crop
  let basePrice = 4500;
...
// --- View Offers Modal (Farmer Accepts Deal) ---
...
function acceptDeal(sampleId, offerIndex) {
  ...
  // Remove sample from active listings
